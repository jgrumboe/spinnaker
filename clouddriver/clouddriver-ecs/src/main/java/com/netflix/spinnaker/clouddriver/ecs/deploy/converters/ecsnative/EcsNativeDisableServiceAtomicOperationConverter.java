...
@EcsNativeOperation(AtomicOperations.DISABLE_SERVER_GROUP)
@Component("ecsNativeDisableServerGroup")
public class EcsNativeDisableServiceAtomicOperationConverter
