...
@EcsNativeOperation(AtomicOperations.TERMINATE_INSTANCES)
@Component("ecsNativeTerminateInstances")
public class EcsNativeTerminateInstancesAtomicOperationConverter
