...
@EcsNativeOperation(AtomicOperations.DESTROY_SERVER_GROUP)
@Component("ecsNativeDestroyServerGroup")
public class EcsNativeDestroyServiceAtomicOperationConverter
