...
@EcsNativeOperation(AtomicOperations.DELETE_SCALING_POLICY)
@Component("ecsNativeDeleteScalingPolicy")
public class EcsNativeDeleteScalingPolicyAtomicOperationConverter
